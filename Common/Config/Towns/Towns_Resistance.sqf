with missionNamespace do {
	...
	GUER_SOLDIERS_SPECOPS = ["GD_I_soldier_SL_F"];
	GUER_SOLDIERS_ENGINEER = [GUER_SOLDIER_ENGINEER, "GD_I_engineer_F"];
	GUER_SOLDIERS_SNIPERS = [GUER_SOLDIER_SNIPER, "GD_I_soldier_M_F", "GD_I_soldier_M_F"];
