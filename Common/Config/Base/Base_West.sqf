...
_classes = _classes 		+ [["US_WarfareBLightFactory_base_EP1", "Land_Medevac_HQ_V1_ruins_F"]];
...
_classes = _classes 		+ [["US_WarfareBHeavyFactory_Base_EP1", "Land_Cargo_HQ_V1_ruins_F"]];
...
_classes = _classes 		+ [["US_WarfareBAircraftFactory_Base_EP1", "Land_Radar_Small_ruins_F"]];
_prices = _prices 			+ [20000];
_times = _times 			+ [140];
...
_classes =  _classes 		+ [["TK_GUE_WarfareBAntiAirRadar_Base_EP1", "Land_TTowerBig_2_ruins_F"]];
_prices =  _prices 			+ [20000];
_times =  _times 			+ [120];
